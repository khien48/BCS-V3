...
const ProfilePage: React.FC<ProfilePageProps> = ({
  ...
  const [formData, setFormData] = useState({
    yourName: user?.name || 'Adore, Joana B.',
    userName: user?.name || 'Adore, Joana B.',
    email: user?.email || 'joanaadore@gmail.com',
    role: 'Cashier',
    password: '**************',
    newPassword: '',
    confirmPassword: '',
            ...
            <div className="flex flex-col md:flex-row gap-8">
              ...
              <div className="relative">
                <div className="w-40 h-40 rounded-full overflow-hidden">
                  <img src="/lovable-uploads/cf783b74-6ef0-4c46-ac99-87bfd5d9f515.png" alt="Profile" className="w-full h-full object-cover" />
                </div>
              ...
              <div className="flex-1 grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="md:col-span-2 flex justify-end space-x-4">
                  ...
                  <Button type="submit" disabled={!isEditing} className="text-white px-8 bg-[208056] bg-bcs-green">
                    Save
                  </Button>
                </div>
              </div>
