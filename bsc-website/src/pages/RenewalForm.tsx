...
export default function RenewalForm() {
  ...
  function handleGoBack() {
    if (step === 0) {
      navigate("/renewal-of-lease-contract");
    } else {
      setStep(step - 1);
    }
  }
      ...
      <main className="flex-1 py-8 px-2 md:px-0 flex flex-col items-center">
        <div className="w-full max-w-3xl mx-auto rounded-3xl flex flex-col gap-8 shadow-none">
          ...
          <div className="flex items-center mt-2 mb-1">
            ...
            <h1 className="text-2xl md:text-3xl font-bold">Renewal of Lease</h1>
...
// NOTE: File is now even longer (200+ lines)! Please consider refactoring into smaller components after reviewing this update.